...
🏠 **Global Airbnb Performance Dashboard – Power BI Analytics Project**
...
This dashboard enables users to analyze **listing growth, pricing trends, customer reviews, and city-wise performance** through interactive visuals and dynamic filtering.

It highlights important aspects such as **market share, seasonality, customer engagement, and host trust metrics**, helping stakeholders understand the Airbnb ecosystem.

This project demonstrates how **Power BI can transform large-scale datasets into actionable insights**.
...
* **📈 Data Modeling** – Relationships between listings, reviews, and cities
...
The dataset contains **global Airbnb data across multiple cities and years**.

### Key data points include:

* Total listings (2,79,712+)
* Number of hosts (1,82,024+)
* Property types (144 categories)
* Total reviews (5.3M+)
* City-wise performance (Paris, New York, Sydney, etc.)
* Pricing by room type
* Customer ratings and review frequency
...
The global short-term rental market is highly competitive, with millions of listings across cities. However, understanding:

* Which cities dominate the market
* How pricing varies across property types
* What drives customer satisfaction
* How seasonality affects bookings
...
* Analyze **Airbnb growth trends over time**
* Identify **top-performing cities and markets**
...
* Rapid growth after 2015 (peak listings)
...
A comparison of **average prices by property type**:

* Hotel rooms are the most expensive
* Entire places follow closely
...
Detailed rating analysis across cities based on:
...
Monthly review trends highlight travel patterns:

* **Paris & Rome peak during summer (April–August)**
* **New York peaks during holiday season (Nov–Dec)**
...
* Over **66% of hosts are fully verified**
...
![Alt text for the image](https://github.com/Adi-hub9/Airbnb-Powerbi-Dashboard/blob/main/Airbnb2.png).
![Alt text for the image](https://github.com/Adi-hub9/Airbnb-Powerbi-Dashboard/blob/main/Airbnb3.png)
